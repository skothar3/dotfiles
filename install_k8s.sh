...
# Set containerd as the container runtime
...
## DISABLE SWAP MEMORY FOR KUBEADM
sudo swapoff -a

# Ensuring iptables sees bridged traffic
...
echo -e "Logout and log back in to update docker user permissions\n"
